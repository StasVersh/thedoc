...
{
    public class ThomsSpawningState : UnmovableState
    {
        public ThomsSpawningState(StateMachine stateMachine, Player player) : base(stateMachine, player)
        {
        }
        ...
        {
            base.Enter();
            _player.Controller.transform.position = _player.SpawnPoint.transform.position;
